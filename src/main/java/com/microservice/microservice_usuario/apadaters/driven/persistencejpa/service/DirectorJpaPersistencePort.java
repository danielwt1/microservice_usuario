...
public class DirectorJpaPersistencePort implements DirectorPersistencePort {

    private final UserRepository userRepository;

    private final UserEntityMapper userEntityMapper;

    public DirectorJpaPersistencePort(UserRepository userRepository, UserEntityMapper userEntityMapper) {
